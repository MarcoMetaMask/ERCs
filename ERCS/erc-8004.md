...
author: Marco De Rossi (@MarcoMetaMask), Davide Crapis <davide@ethereum.org>, Jordan Ellis <jordanellis@google.com>, Erik Reppel <erik.reppel@coinbase.com>
...
* Discovering which agents run in a TEE, and which key to use to trust that instance  
